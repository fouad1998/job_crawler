...
type Props = BoxProps & { description?: ReactNode };
      ...
      <Box
        ...
        <svg width="900" height="600">
          <g clipPath="url(#a)">
            ...
            />
            <path d="m618.839 460.54-64.057-64.057" stroke={color} strokeWidth="29.565" strokeLinecap="round" strokeLinejoin="round" />
            <path
              ...
              strokeLinejoin="round"
            />
            <circle r="15.688" transform="matrix(1 0 0 -1 353.761 498.351)" fill={color} />
            <circle r="18.782" transform="scale(-1 1) rotate(30 -518.683 -1104.96)" fill={color} />
            <circle r="13.877" transform="matrix(1 0 0 -1 173.354 266.055)" fill={color} />
            <circle r="8.447" transform="scale(-1 1) rotate(30 -834.583 -1137.286)" fill={color} />
            <circle cx="249.982" cy="189.428" r="7.24" transform="rotate(-180 249.982 189.428)" fill="#E1E4E5" />
            ...
            <circle r="11.675" transform="scale(-1 1) rotate(30 -316.465 -755.99)" fill="#E1E4E5" />
          </g>
          <defs>
